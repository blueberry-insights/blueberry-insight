// app/candidate/test/[token]/CandidateTestClient.tsx
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        {shouldGroupByDimension(questions) ? (
          // Affichage groupé par dimension
          groupQuestionsByDimension(questions).map((dimension) => (
            <div
          ...
          // Affichage classique (sans groupement)
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-medium">
                    {q.label}
                    {q.businessCode ? (
                      <span className="mr-1 inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-slate-700">
                        {q.businessCode}
                      </span>
                    ) : null}
                  </p>
...
function renderQuestionInput(
  q: TestQuestion,
  current: AnswerState[string] | undefined,
  handlers: {
